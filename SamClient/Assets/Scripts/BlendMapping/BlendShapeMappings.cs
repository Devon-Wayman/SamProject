...
public class BlendShapeMappings : ScriptableObject
{
    ...
    public List<Mapping> Mappings = new List<Mapping>
    {
        ...
        new Mapping { location = ARKitBlendShapeLocation.CheekSquintLeft, name = $"{BLENDSHAPE_EXPRESSION}cheeckSquint_L"},
        ...
        new Mapping { location = ARKitBlendShapeLocation.MouthUpperUpLeft, name = $"{BLENDSHAPE_EXPRESSION}mouthUpperU_L"},
        new Mapping { location = ARKitBlendShapeLocation.MouthUpperUpRight, name = $"{BLENDSHAPE_EXPRESSION}mouthUpperU_R"},
